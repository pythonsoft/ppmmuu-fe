...
config.FIELD_NAME = {
  ...
  ISOK: { cn: '' },
  LANGUAGEID: { cn: '' },
  LASTACCESS: { cn: '最近一次访问' },
  MD5CODE: { cn: 'md5编码' },
  MEDIAINFOFLAG: { cn: '媒体信息标志' },
  NAME: { cn: '名称' },
  OBJECTID: { cn: '' },
  OUTPOINT: { cn: '出点' },
  PATHID: { cn: '路径id' },
  PROCESSSTATUS: { cn: '进度状态' },
  PURGETIME: { cn: '' },
  RESERVED1: { cn: '' },
  RESERVED2: { cn: '' },
  SAID: { cn: '' },
  ...
  SPSTATUS: { cn: '' },
  STATUS: { cn: '状态' },
  STREAMMEDIAID: { cn: '流媒体id' },
  STREAMMEDIAINFO: { cn: '流媒体信息' },
  STREAMMEDIAINFOID: { cn: '流媒体信息id' },
  STREAMTYPE: { cn: '流类型' },
  TAPECODE: { cn: '' },
  UNCPATH: { cn: '' },
  VIDEOSTANDARD: { cn: '视频标准' },
  INPOINT: {
    cn: '入点'
  },
  OUTPOINT: {
