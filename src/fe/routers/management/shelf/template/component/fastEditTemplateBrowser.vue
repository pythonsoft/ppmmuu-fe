  ...
  <fj-dialog
    ...
    <div class="transcode-browser-content">
      <fj-table style="font-size: 12px;" :data="tableData" @current-change="handleCurrentChange" highlight-current-row>
        ...
        <fj-table-column prop="name" label="名字"></fj-table-column>
      </fj-table>
    </div>
...
<script>
  const templateAPI = require('../../../../../api/shelfManage');
  ...
  export default {
    ...
    methods: {
      listTemplate() {
        ...
        templateAPI.listFastEditTemplate({ params: param }, this).then((res) => {
