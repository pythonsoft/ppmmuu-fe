  ...
  <four-row-layout-right-content>
    ...
    <template slot="table">
      <fj-table :data="tableData" name="table1" ref="table" @selection-change="handleSelectionChange">
        ...
        <fj-table-column prop="dealer" label="编目人" align="center" width="260"><template scope="props">{{props.row.dealer.name}}</template></fj-table-column>
        <fj-table-column prop="lastModifyTime" label="操作时间" align="center" width="260"><template scope="props">{{formatTime(props.row.lastModifyTime)}}</template></fj-table-column>
      </fj-table>
    </template>
