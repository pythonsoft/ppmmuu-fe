  ...
  <four-row-layout-right-content>
    ...
    <template slot="table">
      <fj-table :data="tableData" name="table1" ref="table" @selection-change="handleSelectionChange">
        ...
        <fj-table-column prop="status" label="状态"><template scope="props"><div  v-html="formatStatus[props.row.status]"></div></template></fj-table-column>
        ...
        <fj-table-column prop="dealer" label="认领人" align="center" width="260"><template scope="props">{{props.row.dealer.name}}</template></fj-table-column>
