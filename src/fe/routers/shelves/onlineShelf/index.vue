<template>
  <four-row-layout-right-content>
    <template slot="search-left">上架管理(上架)</template>
    ...
    <template slot="table">
      <fj-table :data="tableData" name="table1" ref="table" @selection-change="handleSelectionChange">
        ...
        <fj-table-column prop="lastModifyTime" label="操作时间"><template scope="props">{{formatTime(props.row.lastModifyTime)}}</template></fj-table-column>
      </fj-table>
    </template>
