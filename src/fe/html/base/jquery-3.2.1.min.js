...
!(function (a, b) {
  ...
  is(a) { return !!E(this, typeof a === 'string' && A.test(a) ? r(a) : a || [], !1).length; } }); let F,
    G = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/,
  ...
  }; function N(a) { return a; } function O(a) { throw a; } function P(a, b, c, d) { let e; try { a && r.isFunction(e = a.promise) ? e.call(a).done(b).fail(c) : a && r.isFunction(e = a.then) ? e.call(a, b, c) : b(...[a].slice(d)); } catch (a) { c.apply(void 0, [a]); } }r.extend({ Deferred(b) {
  ...
  when(a) {
    ...
    U = function (a) { return a.nodeType === 1 || a.nodeType === 9 || !+a.nodeType; }; function V() { this.expando = r.expando + V.uid++; }V.uid = 1, V.prototype = { cache(a) { let b = a[this.expando]; return b || (b = {}, U(a) && (a.nodeType ? a[this.expando] = b : Object.defineProperty(a, this.expando, { value: b, configurable: !0 }))), b; },
    set(a, b, c) {
      let d,
    ...
    hasData(a) { const b = a[this.expando]; return void 0 !== b && !r.isEmptyObject(b); } }; let W = new V(),
    X = new V(),
    Y = /^(?:\{[\w\W]*\}|\[[\w\W]*\])$/,
  ...
  removeData(a) { return this.each(function () { X.remove(this, a); }); } }), r.extend({ queue(a, b, c) { let d; if (a) return b = `${b || 'fx'}queue`, d = W.get(a, b), c && (!d || Array.isArray(c) ? d = W.access(a, b, r.makeArray(c)) : d.push(c)), d || []; },
    dequeue(a, b) {
    ...
    _queueHooks(a, b) { const c = `${b}queueHooks`; return W.get(a, c) || W.access(a, c, { empty: r.Callbacks('once memory').add(() => { W.remove(a, [`${b}queue`, c]); }) }); } }), r.fn.extend({ queue(a, b) { let c = 2; return typeof a !== 'string' && (b = a, a = 'fx', c--), arguments.length < c ? r.queue(this[0], a) : void 0 === b ? this : this.each(function () { const c = r.queue(this, a, b); r._queueHooks(this, a), a === 'fx' && c[0] !== 'inprogress' && r.dequeue(this, a); }); },
  ...
  }), r.fn.extend({ on(a, b, c, d) { return ya(this, a, b, c, d); },
  ...
  } function Ka(a, b, c) { for (var d, e = b ? r.filter(b, a) : a, f = 0; (d = e[f]) != null; f++)c || d.nodeType !== 1 || r.cleanData(na(d)), d.parentNode && (c && r.contains(d.ownerDocument, d) && oa(na(d, 'script')), d.parentNode.removeChild(d)); return a; }r.extend({ htmlPrefilter(a) { return a.replace(za, '<$1></$2>'); },
    clone(a, b, c) {
      let d,
        e,
        f,
    ...
    cleanData(a) { for (var b, c, d, e = r.event.special, f = 0; void 0 !== (c = a[f]); f++) if (U(c)) { if (b = c[W.expando]) { if (b.events) for (d in b.events)e[d] ? r.event.remove(c, d) : r.removeEvent(c, d, b.handle); c[W.expando] = void 0; }c[X.expando] && (c[X.expando] = void 0); } } }), r.fn.extend({ detach(a) { return Ka(this, a, !0); },
  ...
  }r.extend({ cssHooks: { opacity: { get(a, b) { if (b) { const c = Oa(a, 'opacity'); return c === '' ? '1' : c; } } } },
    ...
    r.cssHooks[b] = { get(a, c, d) { if (c) return !Qa.test(r.css(a, 'display')) || a.getClientRects().length && a.getBoundingClientRect().width ? $a(a, b, d) : ea(a, Sa, () => $a(a, b, d)); },
      set(a, c, d) {
        let e,
          f = d && Na(a),
    ...
    } }), r.each(['toggle', 'show', 'hide'], (a, b) => { const c = r.fn[b]; r.fn[b] = function (a, d, e) { return a == null || typeof a === 'boolean' ? c.apply(this, arguments) : this.animate(gb(b, !0), a, d, e); }; }), r.each({ slideDown: gb('show'), slideUp: gb('hide'), slideToggle: gb('toggle'), fadeIn: { opacity: 'show' }, fadeOut: { opacity: 'hide' }, fadeToggle: { opacity: 'toggle' } }, (a, b) => { r.fn[a] = function (a, c, d) { return this.animate(b, a, c, d); }; }), r.timers = [], r.fx.tick = function () {
    let a,
      b = 0,
  ...
  } }), r.extend({ valHooks: { option: { get(a) { const b = r.find.attr(a, 'value'); return b != null ? b : pb(r.text(a)); } },
    select: { get(a) {
      let b,
        c,
        d,
  ...
  }), r.ajaxPrefilter((a) => { a.crossDomain && (a.contents.script = !1); }), r.ajaxSetup({ accepts: { script: 'text/javascript, application/javascript, application/ecmascript, application/x-ecmascript' }, contents: { script: /\b(?:java|ecma)script\b/ }, converters: { 'text script'(a) { return r.globalEval(a), a; } } }), r.ajaxPrefilter('script', (a) => { void 0 === a.cache && (a.cache = !1), a.crossDomain && (a.type = 'GET'); }), r.ajaxTransport('script', (a) => {
    if (a.crossDomain) {
      let b,
  ...
  }, r.each(['ajaxStart', 'ajaxStop', 'ajaxComplete', 'ajaxError', 'ajaxSuccess', 'ajaxSend'], (a, b) => { r.fn[b] = function (a) { return this.on(b, a); }; }), r.expr.pseudos.animated = function (a) { return r.grep(r.timers, b => a === b.elem).length; }, r.offset = { setOffset(a, b, c) {
    let d,
      e,
      f,
      g,
  ...
  }), r.fn.extend({ bind(a, b, c) { return this.on(a, null, b, c); }, unbind(a, b) { return this.off(a, null, b); }, delegate(a, b, c, d) { return this.on(b, a, c, d); }, undelegate(a, b, c) { return arguments.length === 1 ? this.off(a, '**') : this.off(b, a || '**', c); } }), r.holdReady = function (a) { a ? r.readyWait++ : r.ready(!0); }, r.isArray = Array.isArray, r.parseJSON = JSON.parse, r.nodeName = B, typeof define === 'function' && define.amd && define('jquery', [], () => r); let Vb = a.jQuery,
